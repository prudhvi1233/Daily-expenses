...
const FilterBar = ({ filters, setFilters }) => {
  ...
  return (
    <div className="bg-slate-800 p-4 rounded-xl border border-slate-700 shadow-md mb-6 flex flex-wrap gap-4 items-center">
      <div className="flex flex-col">
        <label className="text-xs text-slate-400 mb-1">Time Period</label>
        <select 
          value={filters.dateRange} 
          onChange={handleDateChange}
          className="bg-slate-900 border border-slate-700 rounded-lg p-2 text-sm text-slate-200 outline-none focus:border-blue-500"
        >
      ...
      <div className="flex flex-col">
        <label className="text-xs text-slate-400 mb-1">Payment Method</label>
        <select 
      ...
      <div className="flex-1 min-w-[200px] flex flex-col">
        ...
        <input 
          ...
          className="bg-slate-900 border border-slate-700 rounded-lg p-2 text-sm text-slate-200 outline-none focus:border-blue-500 w-full"
        />
      </div>
    </div>
  );
